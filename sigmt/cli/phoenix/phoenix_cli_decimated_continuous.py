...
ts['run1']['ey'] = phoenix_readers.read_decimated_continuous(
    channel_path=station_path / str(channel_map.get('E2')),
    file_extension="td_150",
)

ts['run1']['hx'] = phoenix_readers.read_decimated_continuous(
    channel_path=station_path / str(channel_map.get('H1')),
    file_extension="td_150",
)

ts['run1']['hy'] = phoenix_readers.read_decimated_continuous(
    channel_path=station_path / str(channel_map.get('H2')),
    file_extension="td_150",
)

ts['run1']['hz'] = phoenix_readers.read_decimated_continuous(
