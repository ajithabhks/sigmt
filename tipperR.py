...
def tippall(bandavg):
    ...
    HxHxc = bandavg.get('tHxHxc')
    HyHyc = bandavg.get('tHyHyc')
    HxHyc = bandavg.get('tHxHyc')
    HyHxc = bandavg.get('tHyHxc')
...
def makeband(bandavg,i):
    ...
    HxHxc = bandavg.get('tHxHxc')[i,:].reshape(1,-1)
    HyHyc = bandavg.get('tHyHyc')[i,:].reshape(1,-1)
    HxHyc = bandavg.get('tHxHyc')[i,:].reshape(1,-1)
    HyHxc = bandavg.get('tHyHxc')[i,:].reshape(1,-1)
    ...
    bandavg_single['tHxHxc'] = HxHxc
    bandavg_single['tHyHyc'] = HyHyc
    bandavg_single['tHxHyc'] = HxHyc
