...
**NOTE:** A major update to version 2, which includes a graphical user interface (GUI), will be released in the few days (in September 2024). Please stay tuned for updates to this repository.
##
